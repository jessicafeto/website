    ...
    tiers: [
      {
        ...
        scope: [
          ...
          "Brand strategy essentials — mission, values, audience snapshot",
          "Positioning statement",
          "Primary logo + one variation",
          "Core colour palette",
          "Primary typography",
          "Mini brand guidelines (PDF)",
          "All logo & asset files — print and digital",
        ],
      },
      {
        name: "Signature",
        ...
        builds: "Essential",
        scope: [
          "In-depth strategy & positioning workshop",
          "Audience & competitor insight",
          "Messaging framework & tagline",
          "Tone-of-voice guide",
          "Full logo suite — primary, secondary, submark & favicon",
          "Extended colour system",
          "Full typographic system with hierarchy",
      ...
      },
      {
        ...
        scope: [
          ...
          "Full messaging & copy platform",
          "Photography & art-direction (shoot direction)",
          "Custom illustration or motion identity",
          "Packaging or print collateral design",
          "Extended, print-ready brand book",
    ...
    tiers: [
      {
        ...
        scope: [
          "Discovery & goals session",
          "Up to 3 pages",
          "Editorial, brand-aligned design",
          "Fully mobile-responsive build",
          "Copywriting direction & light copy polish",
          "Contact form",
          "Basic on-page SEO",
          "Launch & handover",
      ...
      },
      {
        ...
        scope: [
          ...
          "Sitemap & content hierarchy",
          "Custom interactions & motion",
          "CMS setup — blog / journal",
          "Integrations — newsletter, analytics, booking",
          "Full SEO foundations — meta, schema, sitemap",
          "Performance optimisation",
          "Accessibility pass",
          "2 weeks of support + a management walkthrough",
        ],
        featured: true,
      },
      {
        ...
        builds: "Signature",
        scope: [
          "8+ pages / complex structure",
          "E-commerce or booking system",
          "Advanced animation & bespoke interactions",
          "Custom CMS collections & dynamic content",
    ...
    tiers: [
      {
        ...
        scope: [
          "One primary channel — Instagram or LinkedIn",
          "Monthly content strategy",
          "Content calendar",
          "8–10 posts / month — copy + design direction",
          "Caption copywriting",
      ...
      },
      {
        ...
        builds: "Essential",
        scope: [
          "Two channels — e.g. Instagram + LinkedIn",
          "12–16 posts / month + stories",
          "Editorial content pillars",
          "One campaign concept per quarter",
          "Email newsletter — 1–2 / month",
          "Photography & art-direction guidance",
          "GA4 & channel analytics dashboard",
      ...
      },
      {
        ...
        scope: [
          ...
          "Blog / journal articles (SEO)",
          "Paid campaign management — Meta & Google (ad spend separate)",
          "Influencer & creator collaborations",
          "Marketing automation & CRM setup",
          "Lead-generation funnels",
          "Conversion-rate optimisation",
          "Monthly growth strategy & reporting",
          "Priority, dedicated partnership",
        ],
      },
    ],
    includes: [
